...
<nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="{{ url('/home') }}" style="font-size: 25px;color: #2b00ff">አ ሚ ኮ </a>
    ...
    <div class="container h-90">
        <div class="row h-90 align-items-center justify-content-center text-center">
            <div class="col-lg-10 align-self-end" id="app">
                <h1 v-if="show" class="text-uppercase  font-weight-bold" style="color: #2b00ff">የአማራ ሚዲያ ኮርፖሬሽን የዕለት ስርጭት ማስፈፀሚያ
                    መርሐ ግብር</h1>
