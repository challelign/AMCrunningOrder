                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select required class="form-control @error('role_id') is-invalid @enderror"
                                            ...
                                            @foreach($role as $r)
                                                @if($r->id == 3 || $r->id == 4  || $r->id == 1 || $r->id == 2 || $r->id == 7 || $r->id == 9 || $r->id == 10 || $r->id == 11)
                                                    @continue
                                                @endif
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="dataTableAdmin" class="table table-bordered table-striped">
                                    ...
                                    @if($i = 0)@endif
                                    @foreach($users as $us)
                                        @if($us->role->id == 3 || $us->role->id == 4  || $us->role->id == 1 || $us->role->id == 2 || $us->role->id == 7 || $us->role->id == 9 || $us->role->id == 10  || $us->role->id == 11)
                                            @continue
                                        @endif
