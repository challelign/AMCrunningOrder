                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <select required class="form-control @error('role_id') is-invalid @enderror"
                                            ...
                                            @foreach($role as $r)
                                                @if($r->id == 3 || $r->id == 4 || $r->id == 5 || $r->id == 6 || $r->id == 1 || $r->id == 2 || $r->id == 7|| $r->id == 8 || $r->id == 11|| $r->id == 12)
                                                    @continue
                                                @endif
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="dataTableAdmin" class="table table-bordered table-striped">
                                    ...
                                    @if($i = 0)@endif
                                    @foreach($users as $us)
                                        @if($us->role->id == 3 || $us->role->id == 4 || $us->role->id == 5 || $us->role->id == 6 || $us->role->id == 1 || $us->role->id == 2 || $us->role->id == 7|| $us->role->id == 8 || $us->role->id == 11 || $us->role->id == 12)
                                            @continue
                                        @endif
